...
exports.signUp = async (req, res) => {
  ...
  try {
    ...
    if (existingUser) {
      return new ResponseHandler(res, 409, false, "User already exists");
    }
...
// validate forget otp
// exports.validateForgetOtp = async (req, res) => {
//   const { enteredOTP, email } = req.body;
//   try {
//     const user = await User.findOne({email});
//     if (!user) {
...
//     user.emailVerified=true;
//     await user.save();
//     return new ResponseHandler(res, 200, true, "OTP is valid", {email}); 
//   } catch (error) {
//     return new ResponseHandler(res, 500, false, error.message);
//   }
// };
